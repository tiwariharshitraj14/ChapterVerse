...
const Navbar = () => {
    ...
    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${sticky ? 'bg-base-100 sticky-navbar shadow-md duration-300 transition-all ease-in-out' : ''}`}>
