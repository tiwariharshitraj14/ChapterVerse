...
const Navbar = () => {
    ...
    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 bg-white text-black dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? 'bg-gray-50 sticky-navbar shadow-md duration-300 transition-all ease-in-out dark:bg-slate-800 dark:text-white' : ''}`}>
